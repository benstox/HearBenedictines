...
version = "Version 1.5.1, last updated Easter Tuesday, 2014."
...
def getofficenamedate(mp3name):
    ...
    # this should sort out Norcia mp3s
        ...
        # i.e. if there is a date in the name
            ...
            correctedrawdate = re.sub('0+', '0', rawdate) # corrects for a typo seen in the past: Laudes201400422n.mp3, an extra zero, too many digits
